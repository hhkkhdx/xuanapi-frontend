...
export async function addPostUsingPOST(body: API.PostAddRequest,
...
export async function deletePostUsingPOST(body: API.DeleteRequest,
  options ?: {[key: string]: any}
) {
...
export async function updatePostUsingPOST(body: API.PostUpdateRequest,
  options ?: {[key: string]: any}
) {
